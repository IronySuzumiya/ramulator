...
string DDR4_PIM::standard_name = "DDR4_PIM";
string DDR4_PIM::level_str [int(Level::MAX)] = {"Ch", "Ra", "Bg", "Ba", "Ro", "Co"};

map<string, enum DDR4_PIM::Org> DDR4_PIM::org_map = {
    {"DDR4_2Gb_x4", DDR4_PIM::Org::DDR4_2Gb_x4}, {"DDR4_2Gb_x8", DDR4_PIM::Org::DDR4_2Gb_x8}, {"DDR4_2Gb_x16", DDR4_PIM::Org::DDR4_2Gb_x16},
    {"DDR4_4Gb_x4", DDR4_PIM::Org::DDR4_4Gb_x4}, {"DDR4_4Gb_x8", DDR4_PIM::Org::DDR4_4Gb_x8}, {"DDR4_4Gb_x16", DDR4_PIM::Org::DDR4_4Gb_x16},
    {"DDR4_8Gb_x4", DDR4_PIM::Org::DDR4_8Gb_x4}, {"DDR4_8Gb_x8", DDR4_PIM::Org::DDR4_8Gb_x8}, {"DDR4_8Gb_x16", DDR4_PIM::Org::DDR4_8Gb_x16},
};

map<string, enum DDR4_PIM::Speed> DDR4_PIM::speed_map = {
    {"DDR4_1600K", DDR4_PIM::Speed::DDR4_1600K}, {"DDR4_1600L", DDR4_PIM::Speed::DDR4_1600L},
    {"DDR4_1866M", DDR4_PIM::Speed::DDR4_1866M}, {"DDR4_1866N", DDR4_PIM::Speed::DDR4_1866N},
    {"DDR4_2133P", DDR4_PIM::Speed::DDR4_2133P}, {"DDR4_2133R", DDR4_PIM::Speed::DDR4_2133R},
    {"DDR4_2400R", DDR4_PIM::Speed::DDR4_2400R}, {"DDR4_2400U", DDR4_PIM::Speed::DDR4_2400U},
    {"DDR4_3200", DDR4_PIM::Speed::DDR4_3200},
};


DDR4_PIM::DDR4_PIM(Org org, Speed speed)
...
DDR4_PIM::DDR4_PIM(const string& org_str, const string& speed_str) :
    DDR4_PIM(org_map[org_str], speed_map[speed_str]) 
{
}

void DDR4_PIM::set_channel_number(int channel) {
  org_entry.count[int(Level::Channel)] = channel;
}

void DDR4_PIM::set_rank_number(int rank) {
  org_entry.count[int(Level::Rank)] = rank;
}

void DDR4_PIM::init_speed()
{
...
void DDR4_PIM::init_prereq()
{
    // RD
    prereq[int(Level::Rank)][int(Command::RD)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
    ...
    prereq[int(Level::Bank)][int(Command::RD)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
        switch (int(node->state)) {
    ...
    // REF
    prereq[int(Level::Rank)][int(Command::REF)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
    ...
    // PD
    prereq[int(Level::Rank)][int(Command::PDE)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
        switch (int(node->state)) {
    ...
    // SR
    prereq[int(Level::Rank)][int(Command::SRE)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
        switch (int(node->state)) {
...
void DDR4_PIM::init_rowhit()
{
    // RD
    rowhit[int(Level::Bank)][int(Command::RD)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
        switch (int(node->state)) {
...
void DDR4_PIM::init_rowopen()
{
    // RD
    rowopen[int(Level::Bank)][int(Command::RD)] = [] (DRAM<DDR4_PIM>* node, Command cmd, int id) {
        switch (int(node->state)) {
            case int(State::Closed): return false;
...
void DDR4_PIM::init_lambda()
{
    lambda[int(Level::Bank)][int(Command::ACT)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::Opened;
        node->row_state[id] = State::Opened;};
    lambda[int(Level::Bank)][int(Command::PRE)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::Closed;
        node->row_state.clear();};
    lambda[int(Level::Rank)][int(Command::PREA)] = [] (DRAM<DDR4_PIM>* node, int id) {
        for (auto bg : node->children)
            for (auto bank : bg->children) {
                bank->state = State::Closed;
                bank->row_state.clear();
            }};
    lambda[int(Level::Rank)][int(Command::REF)] = [] (DRAM<DDR4_PIM>* node, int id) {};
    lambda[int(Level::Bank)][int(Command::RD)] = [] (DRAM<DDR4_PIM>* node, int id) {};
    lambda[int(Level::Bank)][int(Command::WR)] = [] (DRAM<DDR4_PIM>* node, int id) {};
    lambda[int(Level::Bank)][int(Command::RDA)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::Closed;
        node->row_state.clear();};
    lambda[int(Level::Bank)][int(Command::WRA)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::Closed;
        node->row_state.clear();};
    lambda[int(Level::Rank)][int(Command::PDE)] = [] (DRAM<DDR4_PIM>* node, int id) {
        for (auto bg : node->children)
            for (auto bank : bg->children) {
                if (bank->state == State::Closed)
                    continue;
    ...
    lambda[int(Level::Rank)][int(Command::PDX)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::PowerUp;};
    lambda[int(Level::Rank)][int(Command::SRE)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::SelfRefresh;};
    lambda[int(Level::Rank)][int(Command::SRX)] = [] (DRAM<DDR4_PIM>* node, int id) {
        node->state = State::PowerUp;};
}


void DDR4_PIM::init_timing()
{
