...
public:
    ...
    enum class Org;
    enum class Speed;
    DDR4_PIM(Org org, Speed speed);
    DDR4_PIM(const string& org_str, const string& speed_str);
    ...
    Command translate[int(Request::Type::MAX)] = {
        ...
        Command::REF, Command::PDE, Command::SRE, Command::MAX, Command::RD
    };

    /* Prereq */
    function<Command(DRAM<DDR4_PIM>*, Command cmd, int)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<DDR4_PIM>*, Command cmd, int)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<DDR4_PIM>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<DDR4_PIM>*, int)> lambda[int(Level::MAX)][int(Command::MAX)];
